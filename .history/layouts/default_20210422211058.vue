<template>
  <v-app>
    ...
    >
      ...
      <v-list>
        <v-list-item id="arrow">
          <v-btn class="arrow" icon @click.stop="miniVariant = !miniVariant">
            <v-icon
        ...
        <v-list-item-action v-if="miniVariant">
          <v-icon fab dark color="primary" @click="logout">mdi-logout</v-icon>
        </v-list-item-action>
      </v-list>
      <v-list-item v-if="!miniVariant" id="user" class="pl-2">
        <v-list-item-action class="mr-5">
          <v-avatar color="primary">
            <v-icon class="white--text headline">mdi-account-circle </v-icon>
          </v-avatar>
        </v-list-item-action>
        <v-list-item-content class="pt-1">
          <v-spacer />
          <v-list-item-subtitle class="pt-1">
            <v-icon fab dark color="info">mdi-account-cog</v-icon>
            <nuxt-link nuxt :to="localePath(`/`)">
              <v-icon class="pl-2" fab dark color="info" @click="logout"
                >mdi-logout</v-icon
              >
            </nuxt-link>
