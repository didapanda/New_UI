<template>
  <v-app>
    ...
    >
      ...
      <v-btn v-if="!miniVariant" class="button" outlined rounded color="black">
        {{ $t('connect_wallet') }}
      </v-btn>
    </v-navigation-drawer>
...
export default {
  data() {
    return {
      fab: false,
      // miniVariant: this.$vuetify.breakpoint.mdAndDown,
      drawer: true,
    }
  },
  computed: {
    ...
    miniVariant() {
      this.$store.dispatch('setMini', this.$vuetify.breakpoint.mdAndDown)
